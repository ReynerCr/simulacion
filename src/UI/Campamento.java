...
public class Campamento extends JPanel {
    ...
    public Campamento(int x,int y){
        setBounds(x,y,96,96);
        setOpaque(false);

        frames = new Image[3];
        frames[0] = new ImageIcon("src/assets/Campamento/1.png").getImage();
    ...
    public void showHola() {
        ...
        JLabel label = new JLabel("Nivel del campamento: " + nivel + ".  Cantidad tropas:" + cantidad);
