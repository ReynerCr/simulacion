...
public class Cuartel extends JPanel {
    ...
    public Cuartel(int x,int y){
        ...
        frames = new Image[3];
        frames[0] = new ImageIcon("src/assets/Cuartel/1.png").getImage();
    ...
    public void showHola() {
        ...
        JLabel label = new JLabel("Nivel del cuartel: " + nivel + ".  Cantidad tropas:" + cantidad);
