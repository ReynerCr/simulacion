...
public class AlmacenOro extends JPanel {
    ...
    public AlmacenOro(int x,int y){
        setBounds(x,y,96,96);
        setOpaque(false);

        frames = new Image[3];
        frames[0] = new ImageIcon("src/assets/AlmacenOro/1.png").getImage();
    ...
    public void showHola() {
        ...
        JLabel label = new JLabel("Nivel del almacén: " + nivel + ".  Cantidad oro:" + cantidad);
