...
public class Extractor extends JPanel {
    ...
    public Extractor(int x,int y){
        setBounds(x,y,96,96);
        setOpaque(false);

        frames = new Image[3];
        frames[0] = new ImageIcon("src/assets/Recolector/1.png").getImage();
    ...
    public void showHola() {
        ...
        JLabel label = new JLabel("Nivel del extractor: " + nivel + ".  Cantidad elixir:" + cantidad);
